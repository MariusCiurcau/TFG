...
if __name__ == "__main__":
    ...
    report, conf_mat = train_eval_model(df, epochs=epochs, split=split, sample=sample, save_path=f"../models/resnet18_{epochs}_{num_classes}_{suffix}_crossval", crossval=True, num_classes=num_classes)
