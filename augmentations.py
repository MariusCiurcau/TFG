...
def augment_images(input_images_folders, input_labels_folders, output_images_folders, output_labels_folders):
    ...
    for input_images_folder, input_labels_folder, output_images_folder, output_labels_folder in zip(input_images_folders, input_labels_folders, output_images_folders, output_labels_folders):
...
if __name__ == "__main__":
    input_images_folders = ["./Datasets/Dataset/Femurs/split/train/images", "./Datasets/Dataset/Femurs/split/test/images"]
    input_labels_folders = ["./Datasets/Dataset/Femurs/split/train/labels", "./Datasets/Dataset/Femurs/split/test/labels"]
    output_images_folders = ["./Datasets/Dataset/Femurs/split/train/augmented_images", "./Datasets/Dataset/Femurs/split/test/augmented_images"]
    output_labels_folders = ["./Datasets/Dataset/Femurs/split/train/augmented_labels", "./Datasets/Dataset/Femurs/split/test/augmented_labels"]

    augment_images(input_images_folders, input_labels_folders, output_images_folders, output_labels_folders)